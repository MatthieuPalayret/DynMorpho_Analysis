...
public class Params implements Cloneable {
	...
	public File childDir;

	// Internal hidden parameter
	public boolean finalAddedSlice = false;
	...
	public void save(String filePath) {
		...
		params.addValue("Minimal area of a cell (�m�)", minCellSurface * pixelSizeMm2);
		params.addValue("Maximal area of a cell (�m�)", maxCellSurface * pixelSizeMm2);
		...
		params.addValue("Minimal area of a protrusion (�m�)", minAreaDetection * pixelSizeMm2);
