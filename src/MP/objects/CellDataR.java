...
public class CellDataR {
	...
	public static final int REJECT_MANUAL = 1;
	public static final int REJECT_DRAMATIC_CHANGE = 2;
	public static final int REJECT_WHOLE_TRAJ = 3;
	public static final int REJECT_TRAJ_LENGTH = 4;
	public static final int REJECT_404 = 5;
